...
public class saranaPrasarana extends RuangKelas{
   ...
   public void outputan(){
        System.out.println("Jumlah steker = "+getJumlahsteker());
        System.out.println("Kondisi = "+getKondisisteker());
        System.out.println("Posisi = "+getPosisisteker());
        System.out.println("\nJumlah kabel LCD = "+getJumlahkabellcd());
        System.out.println("Kondisi kabel LCD = "+getKondisikabellcd());
        System.out.println("Posisi kabel LCD = "+getPosisikabellcd());
        System.out.println("\nJumlah lampu = "+getPosisilampu());
        System.out.println("Kondisi kabel = "+getKondisilampu());
        System.out.println("Posisi kabel = "+getPosisilampu());
 }
}
